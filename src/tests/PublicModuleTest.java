...
public class PublicModuleTest
{
    ...
    public void publicOne() {
        ...
        System.out.println((this.testHandler.getDistrictOperations().districtDistance(districtIdOne,districtIdTwo)));

        final int type1 = 0;
        final BigDecimal weight1 = new BigDecimal(123);
        System.out.println("All packages: " + this.testHandler.getPackageOperations().getAllPackages());
        ...
        Assert.assertEquals(0L, (long)this.testHandler.getPackageOperations().getDeliveryStatus(packageId1));
        ...
        int offerId = this.testHandler.getPackageOperations().insertTransportOffer(courierUsername, packageId1,null);
        List<PackageOperations.Pair<Integer, BigDecimal>> lst = this.testHandler.getPackageOperations().getAllOffersForPackage(packageId1);
        System.out.println(lst);
        System.out.println(lst.get(0).getFirstParam() + lst.get(0).getSecondParam().toString());
        ...
        final int packageId4 = this.testHandler.getPackageOperations().insertPackage(districtIdTwo, districtIdOne, courierUsername, type3, weight2);
        ...
        this.testHandler.getPackageOperations().acceptAnOffer(offerId);
        System.out.println("Neisporuceni paketi za " + courierUsername + " : " + this.testHandler.getPackageOperations().getDrive(courierUsername));
        System.out.println("All packages: " + this.testHandler.getPackageOperations().getAllPackages());
        ...
        System.out.println("Insertovana ponuda" + this.testHandler.getPackageOperations().insertTransportOffer(courierUsername, packageId4, new BigDecimal(5)));
